This project predicts the monetary valuation of a given real estate.
...
data = "C:/Users/Gabriel/Desktop/Real Estate/real_estate.csv"
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("Real_Estate_without_featuresize_{}".format(feature_size))
    #plt.show()
    print('\n')
