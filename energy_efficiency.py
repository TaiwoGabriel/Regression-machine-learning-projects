# This project predicts two real-valued outputs corresponding to the heating load and cooling load requirements of buildings' shapes
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("Energy_eff_without_featuresize_{}".format(feature_size))
    #plt.show()
    print('\n')
