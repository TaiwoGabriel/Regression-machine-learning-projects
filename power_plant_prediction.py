# This project predicts the predict the net hourly electrical energy outputs (EP) of a power plant
...
data = "C:/Users/Gabriel/Desktop/Combine Cycle Powerplant/power_plant.xlsx"
df = pd.read_csv(data, delimiter=",")
# Inspect data
print('Inspect Data')
print('Normal Data Shape:',df.shape)
#print(df.head(50).to_string())
df = df.sample(frac=0.11)
df = df.sort_index()
#print(df.head(50).to_string())
...
# Visualize the bivariate distribution of the dataset (which shows how each feature correlates to each other and the PE)
sns.set(style='ticks')
...
# Through inspection, the powerplant dataset is a continuous dataset, having float feature values
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("power_without_featuresize_{}".format(feature_size))
    #plt.show()
    print('\n')
