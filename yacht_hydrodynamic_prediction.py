# This project predicts the residuary resistance of sailing yachts at initial design stage
...
# Through inspection, the yacht hydrodynamic dataset is a continuous dataset, having float feature values
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("yacht_without_featuresize_{}".format(feature_size))
    #plt.show()
    print('\n')
