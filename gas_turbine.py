#This project predicts the turbine energy yield of a gas plant with the regression outputs corresponding to CO and Nox gases.
...
# Importing dataset
# Importing or Loading dataset and join them in pandas dataframe
data1 = "C:/Users/Gabriel/Desktop/Gas Turbine/gt_2011.csv"
df1 = pd.read_csv(data1, delimiter=",")
#print(df1.shape)
data2 = "C:/Users/Gabriel/Desktop/Gas Turbine/gt_2012.csv"
df2 = pd.read_csv(data2, delimiter=",")
#print(df2.shape)
#data3 = "C:/Users/Gabriel/Desktop/Gas Turbine/gt_2013.csv"
df3 = pd.read_csv(data3, delimiter=",")
#print(df3.shape)
data4 = "C:/Users/Gabriel/Desktop/Gas Turbine/gt_2014.csv"
df4 = pd.read_csv(data4, delimiter=",")
#print(df4.shape)
data5 = "C:/Users/Gabriel/Desktop/Gas Turbine/gt_2015.csv"
df5 = pd.read_csv(data5, delimiter=",")
#print(df5.shape)
...
print(df_miss) # There are no missing values in the data
...
# Through inspection, the gas turbine dataset is a continuous dataset, having floating feature values
# and no missing values. But it requires data scaling. Also,two target attributes are to be predicted.
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("gas_without_featuresize_{}".format(feature_size))
    print('\n')
