# This code predicts student performance in a high school mathematics subject
...
data = "C:/Users/Gabriel/Desktop/Student_Perf/mat.csv"
...
for column in df[["school", "sex", "address", "famsize", "Pstatus", "Mjob", "Fjob", "reason",
...
# Through inspection, the student performance is a continuous dataset, having float and integer feature values
# and no missing values. The data is well scaled.
...
for feature_size in np.arange(2, 18, 2):
    ...
    plt.savefig("Std_Perf_without_featuresize_{}".format(feature_size))
    #plt.show()
    print('\n')
